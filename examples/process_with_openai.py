#!/usr/bin/env python3
"""
Example: Process sources with OpenAI

This example shows how to use LLM Wiki with OpenAI to automatically
extract entities, concepts, and summaries from source documents.
"""
...
print("📄 Processing unprocessed sources...")
